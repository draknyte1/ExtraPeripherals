...
public class TileRFChargerT1 extends TileRFCharger implements IEnergyProvider,
		IEnergyHandler {
	...
	public ItemStack getWrenchDrop(EntityPlayer entityPlayer) {
		return new ItemStack(BlockRegistry.te4Blocks.get("rfChargerLeadstone"));
	}
