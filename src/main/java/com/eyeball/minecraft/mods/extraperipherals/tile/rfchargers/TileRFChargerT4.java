...
public class TileRFChargerT4 extends TileRFCharger implements IEnergyProvider,
		IEnergyHandler {

	int outputRate = 100000;
	private EnergyStorage storage = new EnergyStorage(80000000);
	private String name = "tileEntityRFCharger";

	public TileRFChargerT4() {
		super();
	}
	...
	public ItemStack getWrenchDrop(EntityPlayer entityPlayer) {
		return new ItemStack(BlockRegistry.te4Blocks.get("rfChargerResonant"));
	}
